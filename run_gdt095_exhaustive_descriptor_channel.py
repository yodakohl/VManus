...
def main():
 ...
 layout_words={"base","edge","ground","level"};panels={"ALL":list(range(len(vocab))),"LAYOUT_POSITION":[i for i,t in enumerate(vocab) if t in layout_words],"APPEARANCE_REMAINDER":[i for i,t in enumerate(vocab) if t not in layout_words]}
