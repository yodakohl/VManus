...
EXTRA_REVIEWS=[DIRECTORY+'/decisions/'+name for name in ['clean_prereg_candidate_review.json','clean_report_proposals_review.json','clean_middle_sidequest_review.json','clean_late_sidequest_review.json','clean_root_early_review.json','clean_final_sidequest_review.json','clean_gap_review_l.json','clean_gap_review_o.json','clean_gap_review_q.json','clean_gap_review_t.json','clean_gap_review_u.json','clean_gap_review_w.json']]
