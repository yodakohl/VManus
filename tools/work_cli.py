...
def main(argv: list[str] | None = None) -> int:
    ...
    if arguments and arguments[0] == 'identity-inputs':
        from tools.identity_input_receipt import main as identity_inputs_main
        return identity_inputs_main(arguments[1:])
