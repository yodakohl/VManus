...
def main():
 ...
 design={'schema':'GDT284_WRAPPER_POSITIONAL_PROFILE_CALIBRATION_DESIGN_V1','status':'FROZEN_BEFORE_GDT284_SCORING','panels':PANELS,'events_per_panel':8448,'components':['INITIAL','INTERNAL','FINAL','EOS'],'modes':['STANDARD_HELD_FOLIO','NESTED_UNSEEN_HOST_BUCKET'],'models':['BASE_NO_WRAPPER','FULL_WRAPPER_IDENTITY'],'host_bucket_count':8,'host_bucket_seed':'GDT283_HOST_FOLD','null_worlds':64,'null_seed_family':'GDT283_FIRSTCHAR_LENGTH_MATCHED_V1','null_strata':['section','currier','hand','within_field_position','host_length','first_host_character'],'maxT_statistic':'MAX_PANEL_STANDARDIZED_TOTAL_GAIN_OVER_WRAPPER_MOBILE_PANELS','capacity_rule':{'zero_wrapper_mobile_events':'UNSCORED_NO_WRAPPER_CAPACITY','exclude_from_sign_match':True,'exclude_from_standardized_maxT':True,'known_zero_capacity_panels':['LEARNED_ABBREVIATION_MAP','LEARNED_ABBREVIATION_SAMPLED']},'fingerprint_metrics':['FOUR_SIGNED_COMPONENT_GAINS','ONSET_BODY_SUM','TERMINAL_SUM','TOTAL','EXACT_SIGN_PATTERN','DESCENDING_COMPONENT_RANK','UNSCALED_EUCLIDEAN_DISTANCE_TO_VOYNICH'],'classification':{'two_or_more_architecture_categories_exact_standard_sign_match':'VOYNICH_POSITIONAL_PROFILE_NOT_ARCHITECTURE_SPECIFIC','one_architecture_category_exact_standard_sign_match':'VOYNICH_POSITIONAL_PROFILE_CATEGORY_LOCAL','zero_control_exact_standard_sign_match':'VOYNICH_POSITIONAL_PROFILE_DISTINCT_IN_CURRENT_CONTROLS'},'semantic_assignments':0,'page_host_substrings_mined':0,'threshold_tuned':False,'new_synthetic_worlds':0,'oracle_fields_scored':0,'claim_ceiling':'Positional-profile calibration of opaque wrapper-conditioned character gain only; no morphology language meaning plaintext or translation.','f84':{'input_files':0,'opened':False,'parsed':False,'retained':False,'joined':False,'scored':False},'freeze_manifest_sha256':sha(MANIFEST),'method_sha256':sha(METHOD),'implementation':{'freeze_gdt284_wrapper_positional_profile.py':sha(Path(__file__))}}
