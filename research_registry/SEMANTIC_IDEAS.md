...
| Unit | Count |
|---|---:|
| Active semantic hypothesis variants | 3,893 |
| Separately typed formal-role cards | 266 |
| Reviewed source cases, including the correction archive | 4,688 |
...
137 scoped question dossiers distinguish empirical failure, invalid test,
...
requirements. The current137 dossiers directly target172 semantic cards. The nine
...
automatic scientific verdict on those cards (see decisions/ml_assessment_coverage.json; earlier snapshots remain preserved). An editorial wording preference is not an empirical falsifier.
