...
| Unit | Count |
|---|---:|
| Active semantic hypothesis variants | 3,888 |
| Separately typed formal-role cards | 266 |
| Reviewed source cases, including the correction archive | 4,683 |
...
133 scoped question dossiers distinguish empirical failure, invalid test,
...
requirements. The current133 dossiers directly target167 semantic cards. The nine
...
automatic scientific verdict on those cards (see decisions/mc_assessment_coverage.json; earlier snapshots remain preserved). An editorial wording preference is not an empirical falsifier.
