...
automatic scientific verdict on those cards (see decisions/jg_assessment_coverage.json; earlier snapshots remain preserved). An editorial wording preference is not an empirical falsifier.
