...
| Unit | Count |
|---|---:|
| Active semantic hypothesis variants | 3,907 |
| Separately typed formal-role cards | 266 |
| Reviewed source cases, including the correction archive | 4,702 |
...
| Public semantic display entries | 3,804 |
...
the ordinary local default therefore displays3,899 semantic entries. A fresh
...
143 scoped question dossiers distinguish empirical failure, invalid test,
...
requirements. The current143 dossiers directly target186 semantic cards. The nine
...
automatic scientific verdict on those cards (see decisions/mt_assessment_coverage.json; earlier snapshots remain preserved). An editorial wording preference is not an empirical falsifier.
