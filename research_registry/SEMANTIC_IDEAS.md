...
| Unit | Count |
|---|---:|
| Active semantic hypothesis variants | 3,884 |
| Separately typed formal-role cards | 266 |
| Reviewed source cases, including the correction archive | 4,679 |
...
| Public semantic display entries | 3,782 |
...
the ordinary local default therefore displays3,877 semantic entries. A fresh
...
131 scoped question dossiers distinguish empirical failure, invalid test,
...
requirements. The current131 dossiers directly target163 semantic cards. The nine
...
automatic scientific verdict on those cards (see decisions/ly_assessment_coverage.json; earlier snapshots remain preserved). An editorial wording preference is not an empirical falsifier.
