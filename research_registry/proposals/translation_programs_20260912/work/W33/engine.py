...
for nominal in NOMINALS:D[nominal]={'role':'MATERIAL','hypothesis':'Zubereitungsposten' if nominal=='ol' else 'Holzportion'}
...
for nominal in NOMINALS:glosses[nominal]='Zubereitungsposten [Nominalhypothese]' if nominal=='ol' else 'Holzportion [Nominalhypothese; Stoffart unbestätigt]'
...
reader=['# W33 vollständige hypothetische Lesung '+RUN_ID+'','W28 plus registrierte unabhängige Nominalhypothesen für ol/lor; keine Bedeutungsbestätigung. Übernommen: shol Q=feucht / A=befeuchte, hier '+SHOL_MODEL+'. chol D=trockne/H=erhitze. Keine Übersetzungsbestätigung. GDT809s beschreibende Rivalen bleiben offen.']
for p in source:
 reader.append('\n## '+p['id'])
 for l in p['lines']:
