...
reader=['# W37 vollständige hypothetische Lesung '+RUN_ID+'','W36 PK plus cfhy-Untereintrag; S abhängig oder I eigenständig; hier '+SCOPE+'; keine Bedeutungsbestätigung. Übernommen: shol Q=feucht / A=befeuchte, hier '+SHOL_MODEL+'. chol D=trockne/H=erhitze. Keine Übersetzungsbestätigung. GDT809s beschreibende Rivalen bleiben offen.']
for p in source:
 reader.append('\n## '+p['id'])
 for l in p['lines']:
