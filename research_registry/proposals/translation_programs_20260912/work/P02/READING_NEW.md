# P02 — vollständige Verlaufsfassung NEW
...
⟦ysho⟧ · kühle(Zielnennung=f29v.4:3;Vollzug erst dort) · Ansatz[A1;neue Instanz;moisture=UNKNOWN;temperature=COLD;texture=UNKNOWN] · Kraut[B1;wiederaufgenommen;moisture=WET;temperature=UNKNOWN;texture=GROUND] · B1:temperature=COLD[INITIAL_CONSTRAINT;vorher=UNKNOWN;Quelle=NA],moisture=DRY[CONFLICT;vorher=WET;Quelle=f29v.1:6] · ⟦s⟧ · erwärme(B1;Quelle=f29v.4:4) · ⟦sho⟧ · Ansatz[A2;neue Instanz;moisture=UNKNOWN;temperature=UNKNOWN;texture=UNKNOWN]
