"""Transfer frozen action/quality contracts to explicitly exposed HERB4."""
...
reader=['# W25 vollständige hypothetische HERB4-Übertragung','Alle Wörter sind feste W16-Annahmen oder ungelesen; chol D=trockne/H=erhitze. Keine Übersetzungsbestätigung. GDT809s beschreibende Rivalen bleiben offen.']
for p in source:
 reader.append('\n## '+p['id'])
 for l in p['lines']:
