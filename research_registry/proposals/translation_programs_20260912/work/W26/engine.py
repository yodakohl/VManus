"""W25 contract reused with exactly one registered shol role/effect rival."""
...
reader=['# W26 vollständige hypothetische Lesung '+SHOL_MODEL+'','W16-Annahmen oder ungelesen; einzige neue Ganzwortalternative shol Q=feucht / A=befeuchte, hier '+SHOL_MODEL+'. chol D=trockne/H=erhitze. Keine Übersetzungsbestätigung. GDT809s beschreibende Rivalen bleiben offen.']
for p in source:
 reader.append('\n## '+p['id'])
 for l in p['lines']:
