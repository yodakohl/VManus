...
reader=['# W28 vollständige hypothetische Lesung N/'+SHOL_MODEL+'','W26 plus Ganzwort sal als Arzneimaterial (Präparat/Salz offen); übernommen: shol Q=feucht / A=befeuchte, hier '+SHOL_MODEL+'. chol D=trockne/H=erhitze. Keine Übersetzungsbestätigung. GDT809s beschreibende Rivalen bleiben offen.']
for p in source:
 reader.append('\n## '+p['id'])
 for l in p['lines']:
