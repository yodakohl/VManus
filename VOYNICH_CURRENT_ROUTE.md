...
GDT412's decisive repair is that 207/301 `CHD` events are open, so closure belongs to the licensed hull, not the core. GDT413 applies the dictionary to every current group, event and statement. GDT414 turns it into a nineteen-core error deck backed by all 8,505 current root mentions. GDT415 supplies 95 reversible register readings, 906 attested root×owner combinations and concrete readings for all 4,576 events/715 statements. GDT416 compiles those into 4,576 imperative clauses and a complete 715-statement readable edition with eleven templates; 1,598 carried actions and 2,096 carried arguments are explicit same-owner state, never hidden word meanings. Role changes, second portable meanings, label lexicalization, unseen atoms and scope-crossing repairs remain red failures. These are working meanings, not confirmed lexemes or plaintext.
