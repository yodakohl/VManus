...
GDT433 permits a bounded second ring only through two-arm squares. Of 21 squares/14 targets, only `AIR+AIN` (BAHN · ANTEIL) and `P+L` (EINSETZEN · VERBINDUNG) have four observed bases and four strong arms, so only those become weaker Amber-II cards. GDT434 folds the resulting 49-card main deck into an executable exact-recipe reader: 1,268 observed recipes outrank four high, 43 strong and two Amber-II cards; 246 narrow recipes stay in an exact-key-only appendix and every other known-atom combination stops. Its 1,563-key catalog, 245 register readings and eight end-to-end tests pass 27/27 checks. Four natural-phrase collision pairs in the narrow appendix confirm that matching must use component order, never German wording. No surface, value or page is added.
