...
## GDT754–GDT762 corrected whole-form formula and content bridge
...
Next, stay on the admitted cache and distinguish `pcheey` and matched H1 contexts as content head, source/complement, parallel record field or result by their following quality, amount, material, related-form and closure roles. In parallel classify the sixteen `ol` amount contacts as head, object, context or source against matched quantity-bearing content wholes. The route-check shows this is narrower than GDT736's global record roles, GDT739's generic local-host dispatch and GDT685's universal-`ol` head rejection. Do not choose oil, water or wine before this head-versus-record distinction.
Primary routing references: `experiments/EXPERIMENT_INDEX.tsv`, `VOYNICH_ACTIVE_STATE.md`, the ledger, grammar registry and closed-route registry.
