...
## GDT754–GDT755 corrected concrete whole-form bridge

GDT754 removes the literal prose from all 172 active source-composed wholes without deleting the hypotheses. GDT755 then assigns one short concrete historical-register candidate plus two rivals to each fixed top-24 whole over 448 reader-exact positions/125 pages and 198 complete independent fields: 2 C2, 15 C1 and 7 deliberately bold C0 defaults. The strongest lead is `ychor=nimm`: all 13 exact occurrences are line-initial, uniquely among 373 forms with at least ten occurrences, none is paragraph-initial, and 3/8 complete fields are prescriptive recipe fields. Most other top-24 forms occupy degree/part/quality/process roles; literal water, wine, oil, salt, plant part, patient and vessel slots must be sought among other learned wholes. Reports: `experiments/yolo/gdt754_active_productive_compound_provenance_sieve/REPORT.md` and `experiments/yolo/gdt755_top24_historical_register_crosswalk/REPORT.md`.
The next route tests `ychor`, final amount candidates `okam/chdam`, and degree candidates in recurring complete line frames, then uses the resulting slot geometry to search outside the top 24 for concrete ingredient/content wholes. Keep primary candidates and rivals alive until a repeated frame displaces them; do not export EVA character, Latin-initial or substring meanings.
