...
Its creative Pass-1021 release binds 4,581 groups (3,888 running, 693 local) in one physically ordered 627-statement edition.
...
All 627 statements now have an owner–quantity–action–relation–grade–endpoint reading; the 19 local signs reduce to HIER, VARIANTE, KLASSE and VORBEZUG. One apprentice sheet of 19 cores, 8 controls, 4 local channels and 11 opening rules covers all 3,888 running events. Complete f13r (77 cards) and f67r2 (126 cards) roundtrips need no extra root. Its 40 immediate duplicate cores split into 28 package-scope descents and 12 free plurals/repeats; `OR+OR` on f13r is outer plus inner EINHEIT. Cross-register and four-image rereading keep `AIIN=WERT`, `AIN=ANTEIL`, and `OR=EINHEIT`; pictures supply the local expansion.
## Scientific ceiling
