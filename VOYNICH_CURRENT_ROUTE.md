...
P01 exploratory reading2026-09-12: research_registry/proposals/translation_programs_20260912/work/P01/REPORT.md. All145HERB4groups;6finding3grade3action forms41positions104open. Eight decisions:2conditional matches2rule contradictions4no prior decisive finding. All28pairs:1same nonempty register/different action onf29v (dependent on late contradiction),6empty-register pairs not clinical equivalence.23findings10grades8unbound. D fixed priority not retained;R state presentation only;0meanings.13programs partial17unstarted;next P07 body-route/station rival, primary review pending. No held pages/admissions/contacts;f84/f84r sealed.
