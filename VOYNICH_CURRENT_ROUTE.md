...
S06 exposed synthesis2026-09-12 / IDEA000179: research_registry/proposals/translation_programs_20260912/work/S06/REPORT.md. Fixed P05 M/K all39f32v.7–11groups35hypotheses4open;7quantity fields8actions. Two local manufacturing chains, no full genealogy. Added ctho-origin bridge requires2Q<=Q only under shared positive mass/disjoint-output assumptions;that conjunction fails, no isolated word refuted. Nominal rival remains;0meanings. Next: compare output/input/alternative roles across already exposed double-dose contexts;no held access;f84/f84r sealed.
