...
GDT412's decisive repair is that 207/301 `CHD` events are open, so closure belongs to the licensed hull, not the core. GDT413 applies the dictionary to every current group, event and statement. These are working meanings, not confirmed lexemes or plaintext; concrete objects and techniques remain local to the visible owner or master exemplar.
