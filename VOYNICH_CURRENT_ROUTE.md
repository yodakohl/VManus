...
P09/P05 exploratory readings2026-09-12: work/PROGRESS.md under research_registry/proposals/translation_programs_20260912/. P09 four145-group drafts,62hypothesis positions/83open;2conditional harm/corrective bindings, no identified effect. P05 V03 dry-powder/sieving then liquid processing is current candidate:52assumed wholes,90/145positions,55open;3conditional double-field references. qotchy≈sieve is hypothetical, not a word identification. Wet/nominal rivals retained. Next: material identity/time, especially wet→dry;28programs unstarted. No held pages/new admissions/contacts; f84/f84r sealed. No prior confirmed anchor required for continued hypotheses.
