...
## GDT754–GDT758 corrected whole-form formula and content bridge
...
GDT758 follows the eleven different direct `ychor` followers through 1,141 reader-exact cached occurrences, 907 loci and 175 already admitted cache pages—not newly inspected pages—and revises all eleven forced defaults plus 23/71 `ychor` body positions. The strongest repair is **`s=je/zu gleichen Teilen`**, replacing unsupported `s=Samen`: 25/99 exact right contexts are `an/ain/aiin/aiiin` (lift 11.684), while `s aiin` alone occurs 23 times (lift 14.494); `or/ar/s` form a competing amount ecology. Other live wholes are `cthy=Blattgut`, `chol=trocken/getrocknet`, `qokchol=erhitzt und getrocknet`, `sheol=feucht/eingeweicht`, `ar=Anteil`, `odol=abgemessene Zubereitung`, and the weaker `chor=Blüten-/Samenstand`, `chshoty=kalte Trockenzubereitung`, `ols=abgeseihtes Endprodukt`. Eight observed exact spans get local fluent renderings without component export. Reports: `experiments/yolo/gdt756_ychor_line_frame_content_slots/REPORT.md`, `experiments/yolo/gdt757_initial_formula_role_atlas/REPORT.md`, `experiments/yolo/gdt758_ychor_follower_global_content_census/REPORT.md`.
Next: follow `s/or/ar + an/ain/aiin/aiiin`, `chor/cthy + chol/qokchol/sheol`, and `odol/ols` amount/preparation versus process/result globally, keeping alternatives and exporting no letter, substring or EVA-to-Latin resemblance.
