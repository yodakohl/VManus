...
GDT929 fixed four-form census: experiments/yolo/gdt929_fixed_four_form_context_square/REPORT.md. All4forms attested,874reading occurrences/719eligibleframes. Three shared cheey/sheey immediate frames across6leaves (6readingcases);no l-edge/no fullsquare;no all3reading frame. Literal comparison only;no l/body meaning, wider-window repair or new admission. f84/f84r sealed.
