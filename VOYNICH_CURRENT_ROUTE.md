...
## GDT754–GDT760 corrected whole-form formula and content bridge
...
GDT760 joins the 96 separated spans with 185 reader-exact fused amount forms. Among 281 expressions on 98 cached pages, 45 clean MATERIAL/PREPARATION contacts produce 44 occurrence-scoped phrases and 35 content wholes. A universal left ingredient slot fails (20/163 left versus 25/204 right); line-first amounts lead right (14/72), internal amounts lead left (19/140 versus 11/132), and line-final attachment is sparse (1/23). `cheor/sheor` supplies a six-contact dry/moist drug-part contrast and `cheo/sheo` a three-contact dry/moist preparation contrast; `cthy or aiin` yields the concrete lead “three portions leaf drug.” Water and wine remain indistinguishable rivals, oil has zero direct contacts here, salt remains retired and dry contacts do not identify powder. Fused `s` is line-first 76/145 versus 0/25 separated `s+value`; only 3/15 within-paragraph initial transitions increase, so a simple entry ordinal fails. Drachms remain the contextual lead, but the unconditional fused spoken overlay is removed; 22 fused positions retain exact content-attached amount phrases. Next: expand `cheor/sheor` and `cheo/sheo` outward in the existing cache to seek learned plant-part and solvent wholes. Report: `experiments/yolo/gdt760_quantity_bilateral_content_attachment/REPORT.md`.
