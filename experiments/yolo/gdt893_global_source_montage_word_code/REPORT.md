...
plaintext alternatives. No extra identification gain is inferred from that fact.

The sole RF projection binds G807-P0407, f103v.30–32,28 groups to a continuous
28-word window in ALIM213, Guido Aretinus's Liber mitis, source segment0042,
zero-based start175. All source provenance and the conditional26-value map
are in RF_FORCED_SOURCE.json. Source-only TXT/HTML collation verifies continuity
and page marker86. Both ends truncate sentences; this is an arbitrary source
window, not a naturally bounded copied Latin paragraph.

The finite14-witness source pool contains153031 normalized tokens. Witnesses
are not independent traditions; some are later comparators. Source identity,
Latin language, phonetic values, significance and confirmed word meanings are
