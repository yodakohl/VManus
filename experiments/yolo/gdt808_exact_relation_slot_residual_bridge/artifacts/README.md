...
At registration this directory contains only `REGISTERED_VALIDATION.json`.
The official builder will reconstruct and emit:
...
word in this experiment has automatic renderer or semantic credit.
