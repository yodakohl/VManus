#!/usr/bin/env python3
"""Prepare one GDT470 worksheet row with GDT471 empirical familiarity."""
...
def main() -> int:
    ...
    surface_templates = read_tsv(BASE / "artifacts/gdt471_71_empirical_surface_templates.tsv")
    component_templates = read_tsv(BASE / "artifacts/gdt471_69_component_templates.tsv")
    topologies = read_tsv(BASE / "artifacts/gdt471_16_slot_topologies.tsv")
