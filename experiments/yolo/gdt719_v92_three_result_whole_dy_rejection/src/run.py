#!/usr/bin/env python3
"""Build V92 by separating three learned result-whole cores from local heads."""
...
SOURCE_LEXICAL = G718 / "V91_324_ACTIVE_LEXICAL_READINGS.tsv"
SOURCE_CONTEXT = G718 / "V91_479_CONTEXT_REALIZATIONS.tsv"
SOURCE_COMPLETE = G718 / "V91_COMPLETE_WORD_CONFIDENCE.tsv"
SOURCE_CENSUS = G718 / "V91_64_HELD_READING_AUDIT.tsv"
SOURCE_SPANS = G718 / "V91_2_BOUND_SPAN_RENDERER.tsv"
SPECS = SRC / "V92_3_AUDIT_SPECS.tsv"
BINDINGS = SRC / "V92_34_PRIMARY_EVIDENCE_BINDINGS.tsv"

HISTORICAL = "H0_NONE"
STATUS = (
    "PASS_V92_3_RESULT_WHOLES_REVISED__SHARED_DY_DECOMPOSITION_REJECTED__"
...
def v92_key(value: str) -> str:
    return value.replace("v91", "v92").replace("V91", "V92")


def rename_v91_fields(row: dict[str, str]) -> dict[str, str]:
    return {v92_key(key): value for key, value in row.items()}
...
def build_lexical(
    ...
    for source in source_rows:
        ...
        if spec:
            ...
            row.update({
                "v92_lexical_core_de": spec["v92_lexical_core_de"],
                "v92_context_realizations_de": spec["v92_context_realization_de"],
                ...
                "source_gdts": append_pipe(source["source_gdts"], "GDT719"),
                "positive_evidence_de": (
                    "GDT719 trennt den portablen Ergebnis-/Zustandskern vom lokalen Produktkopf: "
                    + spec["evidence_de"] + " || " + source["positive_evidence_de"]
                ),
                "counterevidence_de": (
                    "GDT719 Gegenbeleg: " + spec["counterevidence_de"]
                    + " || Historisch unbestaetigte Arbeitstheorie; keine Klartextidentifikation."
                ),
                "v92_audit_decision": "REVISE",
                "v92_evidence_class": spec["evidence_class"],
                "v92_open_semantic_slots": spec["open_semantic_slots"],
                "v92_component_global_export_allowed": "0",
                "v92_prior_lexical_core_de": source["v91_lexical_core_de"],
            })
        else:
            row.update({
                "v92_audit_decision": "NOT_IN_GDT719_TRANCHE",
                "v92_evidence_class": "INHERITED_V91",
                "v92_open_semantic_slots": "NOT_EVALUATED",
                "v92_component_global_export_allowed": "NOT_EVALUATED",
                "v92_prior_lexical_core_de": source["v91_lexical_core_de"],
            })
        output.append(row)
...
def build_contexts(
    ...
    for source in source_rows:
        ...
        row.update({
            "v92_reading_id": lexical["v92_reading_id"],
            "v92_lexical_core_de": lexical["v92_lexical_core_de"],
            "v92_context_realization_de": spec["v92_context_realization_de"] if spec else source["v91_context_realization_de"],
            "v92_repair_mode": spec["repair_mode"] if spec else source["v91_repair_mode"],
            "v92_resolved_debt_atom": spec["resolved_debt_atom"] if spec else source["v91_resolved_debt_atom"],
            "v92_lexical_score": lexical["working_model_score_0_100_not_probability"],
            "v92_lexical_level": lexical["working_model_level"],
            "v92_context_score": lexical["context_realization_score_0_100_not_probability"],
            "v92_context_level": lexical["context_realization_level"],
            "v92_semantic_scope": lexical["semantic_scope"],
            "v92_semantic_applicability": lexical["semantic_applicability"],
            "v92_global_export_scope": lexical["global_export_scope"],
            "v92_lexical_bound_span_ids": lexical["bound_span_ids"],
            "v92_unconditional_global_export_allowed": lexical["unconditional_global_export_allowed"],
            "v92_historical_confirmation": HISTORICAL,
            "v92_audit_decision": "REVISE" if spec else "NOT_IN_GDT719_TRANCHE",
            "v92_evidence_class": spec["evidence_class"] if spec else "INHERITED_V91",
            "v92_open_semantic_slots": spec["open_semantic_slots"] if spec else "NOT_EVALUATED",
            "v92_component_global_export_allowed": "0" if spec else "NOT_EVALUATED",
            "v92_local_context_hypothesis": spec["local_context_hypothesis"] if spec else "NONE",
            "v92_expected_left_surface": spec["expected_left_surface"] if spec else "NONE",
        })
        output.append(row)
...
def build_census(
    ...
    for source in source_rows:
        ...
        if spec:
            row.update({
                "disposition": "REVISED_IN_V92",
                "repair_mode": spec["repair_mode"],
                "resolved_debt_atom": spec["resolved_debt_atom"],
                "v92_reading_id": lexical["v92_reading_id"],
                "v92_lexical_core_de": lexical["v92_lexical_core_de"],
                "v92_context_realization_de": spec["v92_context_realization_de"],
            ...
            row.update({
                "v92_reading_id": lexical["v92_reading_id"],
                "v92_lexical_core_de": lexical["v92_lexical_core_de"],
                "v92_context_realization_de": lexical["v92_context_realizations_de"],
                "new_lexical_score": lexical["working_model_score_0_100_not_probability"],
                "new_lexical_level": lexical["working_model_level"],
                "new_context_score": lexical["context_realization_score_0_100_not_probability"],
                "new_context_level": lexical["context_realization_level"],
                "v92_audit_decision": "HELD_FOR_LATER_REPAIR",
                "v92_evidence_class": "INHERITED_V91",
                "v92_open_semantic_slots": "NOT_EVALUATED",
            })
        output.append(row)
...
def build_delta(
    ...
    for spec in specs:
        ...
        output.append({
            ...
            "left_surface": spec["expected_left_surface"], "old_lexical_core_de": source["v91_lexical_core_de"],
            "v92_lexical_core_de": target["v92_lexical_core_de"],
            "v92_context_realization_de": spec["v92_context_realization_de"],
            "old_score": source["working_model_score_0_100_not_probability"],
            "v92_score": target["working_model_score_0_100_not_probability"],
            "old_level": source["working_model_level"], "v92_level": target["working_model_level"],
...
def build_rejected_family(specs: list[dict[str, str]]) -> list[dict[str, Any]]:
    return [{
        "candidate_family_id": "REJECTED_SHARED_FREE_DY_DECOMPOSITION",
        ...
        "candidate_value_de": "freies DY als einheitlicher Abschluss-/Ergebnisträger",
        "decision": "REJECT_NO_COMMON_LICENSED_WRITTEN_UNIT",
        "reason_de": "GDT689 klassifiziert kchody und ochdy als NO_FORMAL_DY mit verschiedenen Ganzwortanalysen; oechedy bleibt UNRESOLVED ohne reale Schwester. DY wird nicht exportiert.",
...
def build_complete(source_rows: list[dict[str, str]], lexical: list[dict[str, Any]]) -> list[dict[str, Any]]:
    output: list[dict[str, Any]] = []
    for source in source_rows:
        if source["current_layer"] == "ACTIVE_V91_LEXICAL_CORE":
            continue
        row: dict[str, Any] = rename_v91_fields(source)
        row.update({
            "v92_audit_decision": "OUTSIDE_ACTIVE_V92_TRANCHE",
            "v92_evidence_class": "INHERITED_GLOBAL_V48",
            "v92_open_semantic_slots": "NOT_EVALUATED",
            "v92_component_global_export_allowed": "NOT_EVALUATED",
        })
        output.append(row)
    for row in lexical:
        output.append({
            "surface": row["surface"], "reading_id": row["v92_reading_id"],
            "working_meaning_de": row["v92_lexical_core_de"], "current_layer": "ACTIVE_V92_LEXICAL_CORE",
            ...
            "v92_context_realizations_de": row["v92_context_realizations_de"],
            "source_reading_ids": row["source_reading_ids"], "v92_audit_decision": row["v92_audit_decision"],
            "v92_evidence_class": row["v92_evidence_class"], "v92_open_semantic_slots": row["v92_open_semantic_slots"],
            "v92_component_global_export_allowed": row["v92_component_global_export_allowed"],
        })
...
def render_f7r2(contexts: list[dict[str, Any]], directives: list[dict[str, Any]]) -> list[dict[str, Any]]:
    ...
    for source in source_rows:
        ...
        if directive:
            ...
            rendered = source["v92_context_realization_de"]
...
def report_text(result: dict[str, Any], delta: list[dict[str, Any]]) -> str:
    table = "\n".join(
        f"| `{row['surface']}` | {row['v92_lexical_core_de']} | {row['v92_context_realization_de']} | {row['old_score']}→{row['v92_score']} |"
        for row in delta
    )
    return f"""# GDT719 — V92 result-whole repair with shared-DY rejection

Status: `{STATUS}`

## Ergebnis

Drei konkrete GDT691-Produktkoepfe werden auf engere portable Zustandskerne
zurueckgefuehrt. Eine gemeinsame freie DY-Zerlegung wird ausdruecklich
verworfen: zwei Formen sind GDT689 `NO_FORMAL_DY`, die dritte ist `UNRESOLVED`
und besitzt keine reale Schwester.

| Form | portabler Kern | konkrete Fundstelle | Score |
|---|---|---|---:|
{table}

`kchody` behaelt heiß-trocken und abgeschlossen, `ochdy` trocken und
abgeschlossen, `oechedy` bis Mittelstufe getrocknet und abgeschlossen.
...
- V92 aktiv: `{json.dumps(result['active_level_counts'], ensure_ascii=False, sort_keys=True)}`
...
Zubereitung, Masse und Trockenmasse bleiben ersetzbare lokale Renderer. Es wird
kein freies DY oder eine andere Binnenkomponente exportiert. Alle historischen
...
def main() -> int:
    ...
    assert len(census) == 61 and Counter(row["disposition"] for row in census) == Counter({"HELD_FOR_LATER_REPAIR": 58, "REVISED_IN_V92": 3})
    ...
    lexical_fields = unique_fields([v92_key(field) for field in source_lexical[0]] + ["v92_audit_decision", "v92_evidence_class", "v92_open_semantic_slots", "v92_component_global_export_allowed", "v92_prior_lexical_core_de"])
    context_fields = unique_fields([v92_key(field) for field in source_context[0]] + ["v92_audit_decision", "v92_evidence_class", "v92_open_semantic_slots", "v92_component_global_export_allowed", "v92_local_context_hypothesis", "v92_expected_left_surface"])
    census_fields = unique_fields([v92_key(field) for field in source_census[0]] + ["v92_audit_decision", "v92_evidence_class", "v92_open_semantic_slots"])
    complete_fields = unique_fields([v92_key(field) for field in source_complete[0]] + ["v92_audit_decision", "v92_evidence_class", "v92_open_semantic_slots", "v92_component_global_export_allowed"])

    write_tsv(ART / "V92_324_ACTIVE_LEXICAL_READINGS.tsv", lexical_fields, lexical)
    write_tsv(ART / "V92_479_CONTEXT_REALIZATIONS.tsv", context_fields, contexts)
    write_tsv(ART / "V92_61_HELD_READING_AUDIT.tsv", census_fields, census)
    write_tsv(ART / "V92_3_RESULT_WHOLE_CORE_CONTEXT_DELTA.tsv", list(delta[0]), delta)
    write_tsv(ART / "V92_34_PRIMARY_EVIDENCE_BINDINGS.tsv", list(evidence[0]), evidence)
    write_tsv(ART / "V92_1_REJECTED_SHARED_DY_DECOMPOSITION.tsv", list(rejected_family[0]), rejected_family)
    write_tsv(ART / "V92_2_BOUND_SPAN_RENDERER.tsv", list(spans[0]), spans)
    write_tsv(ART / "V92_2_ONE_SHOT_RENDER_DIRECTIVES.tsv", list(directives[0]), directives)
    write_tsv(ART / "V92_8_F7R2_RENDERED_UNITS.tsv", list(rendered[0]), rendered)
    write_tsv(ART / "V92_COMPLETE_WORD_CONFIDENCE.tsv", complete_fields, complete)

    result = {
        "experiment_id": "GDT719", "status": STATUS,
        "claim_ceiling": "EXPLORATORY_WORKING_DICTIONARY_ONLY_NOT_PLAINTEXT",
        "audited_readings": 3, "audited_positions": 3, "audited_pages": 3,
        "learned_result_wholes": 3, "shared_free_dy_decomposition_accepted": 0,
        ...
        "remaining_unreviewed_weak_readings": sum(row["v92_audit_decision"] == "HELD_FOR_LATER_REPAIR" for row in census),
        ...
        "relation_word_credit_gdt719": 0, "historical_confirmation": HISTORICAL,
