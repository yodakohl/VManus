...
if args.lock:
    ...
    science = ['DECISION.md', 'METHOD.md', 'PREREGISTRATION.md', 'requirements.txt',
               ...
               'artifacts/ORIGINAL_CANDIDATES.json', 'artifacts/MODEL_DELTA.json',
...
m.update(question='Which complete transport extensions remain possible when each THEN refers to a fresh completed voyage interval?',
