...
1. **H1-S001** `OWNER_ITEM>SOURCE>QUANTITY>PREPARATION>OPERATION>FLOW_TRANSFER` — Wurzelteil; säubern; aus demselben Vorrat; zerkleinern; Gefäß; Flüssigkeitszulauf; ersten Auszug auffangen; den laufenden Posten einsetzen; vorgeschriebenes Maß; Wurzelteil.
...
1. **H2-S001** `OWNER_ITEM>QUANTITY>PREPARATION>OPERATION>STATE_GRADE` — Pflanzenspitzen; gebrauchsfertig; Zubereitung; Kraut zerstoßen; durch Tuch; dieser Arbeitsposten; dieser Arbeitsposten; vorgeschriebenes Maß; dieser Arbeitsposten.
...
4. **H5-S004** `OWNER_ITEM>PREPARATION>OPERATION>FLOW_TRANSFER` — Den laufenden Posten einsetzen; Auszugsflüssigkeit zugeben; durch Tuch.
...
11. **B1-S011** `OWNER_ITEM>OPERATION` — Durch verbundenen Lauf; den laufenden Posten einsetzen.
12. **B1-S012** `OWNER_ITEM>OPERATION>FLOW_TRANSFER>STATE_GRADE>CLOSE` — Spülung beginnen; den laufenden Posten kurz anlegen; waschen; Ende.
...
18. **B1-S018** `QUANTITY>OPERATION>TARGET>STATE_GRADE>CLOSE` — Gefäß füllen; Stelle bestreichen; Sollstufe; an der Auffangstelle länger halten; Schluss.
...
4. **B2-S004** `OWNER_ITEM>OPERATION>FLOW_TRANSFER>TARGET>STATE_GRADE>CLOSE` — An der Zielstelle einsetzen; zweite Öffnung; hinausführen; den laufenden Posten länger einwirken lassen; klar seihen; Ende.
5. **B2-S005** `OWNER_ITEM>QUANTITY>OPERATION>TARGET>STATE_GRADE>CLOSE` — Den laufenden Posten an der Zielstelle einsetzen; durch Tuch; durch verbundenen Lauf; auf das vorgeschriebene Maß einstellen; auf das vorgeschriebene Maß einstellen; gleiche Einstellung; den laufenden Posten länger warm halten; abziehen; Ende.
...
10. **B2-S010** `OWNER_ITEM>OPERATION>FLOW_TRANSFER>STATE_GRADE` — Den laufenden Posten länger einwirken lassen; den laufenden Posten einsetzen; erste Öffnung; klare Flüssigkeit.
...
15. **B2-S015** `OPERATION>STATE_GRADE>CLOSE` — Spülung beginnen; länger einweichen; Schluss.
...
1. **B3-S001** `TARGET>STATE_GRADE>CLOSE` — An der Auffangstelle länger halten; Schluss.
...
26. **B3-S026** `OWNER_ITEM>QUANTITY>OPERATION>TARGET>STATE_GRADE>CLOSE` — Beckenstation; bis zum vorgeschriebenen Stand absetzen lassen; den laufenden Posten umsetzen oder durcharbeiten; eine Portion zugeben; gebrauchsfertig; bis klar; an der Auffangstelle länger halten; Schluss.
...
5. **B4-S005** `OWNER_ITEM>OPERATION>STATE_GRADE>CLOSE` — Durch Tuch; den laufenden Posten umsetzen oder durcharbeiten; länger einweichen; Schluss.
...
15. **B4-S015** `OWNER_ITEM>QUANTITY>OPERATION>FLOW_TRANSFER>TARGET>STATE_GRADE>CLOSE` — Eine Portion zugeben; klare Flüssigkeit; eine Portion; Dauer; den Posten kurz an der Auffangstelle halten; hinausführen; Schluss.
...
1. **B6-S001** `OWNER_ITEM>QUANTITY>OPERATION>TARGET>STATE_GRADE` — Den Posten länger an der Auffangstelle halten; ungekocht; erste Öffnung; mit Vorigem weiter; vorgeschriebenes Maß; mit Vorigem weiter; durch Tuch; dieser Arbeitsposten; bezeichnete Zielstelle.
