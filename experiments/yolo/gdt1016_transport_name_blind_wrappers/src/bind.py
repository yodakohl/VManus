...
if args.lock:
    ...
    science = ['DECISION.md', 'METHOD.md', 'PREREGISTRATION.md', 'requirements.txt',
               ...
               'artifacts/ORIGINAL_CANDIDATES.json', 'artifacts/WRAPPER_SCOPE.json',
...
m.update(question='Which retained complete transport readings admit unary participant-neutral wrapper operations under all six cargo renamings?',
         ...
         dependencies=['GDT928', 'GDT993', 'GDT994', 'GDT1006', 'GDT1011', 'GDT1012', 'GDT1013', 'GDT1014'],
         status=args.status,
